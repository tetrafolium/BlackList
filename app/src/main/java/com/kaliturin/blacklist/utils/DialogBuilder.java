 ...
 **/
public DialogBuilder addItem(int id, @StringRes int titleId,
                             View.OnClickListener listener) {
 ...
 **/
public DialogBuilder addItem(int id, @StringRes int titleId, Object tag,
                             View.OnClickListener listener) {
	String title = context.getString(titleId);
 ...
 * Adds the new item to the list with title and click listener
 **/
public DialogBuilder addItem(String title,
 ...
 * Adds the new item to the list with id, title and click listener
 **/
public DialogBuilder addItem(int id, String title,
                             final View.OnClickListener listener) {
 ...
 * Adds the new item to the list with id, title, tag and click listener
 **/
public DialogBuilder addItem(int id, String title, Object tag,
                             final View.OnClickListener listener) {
...
addButtonRight(String title, DialogInterface.OnClickListener listener) {
 ...
 **/
public DialogBuilder
addButtonCenter(String title, DialogInterface.OnClickListener listener) {
	return addButton(R.id.button_center, title, listener);
}

private DialogBuilder
addButton(@IdRes int buttonId, String title,
