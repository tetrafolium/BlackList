...
public class IdentifiersContainer implements Cloneable {
  ...
  public boolean isFull() { return (all && ids.size() == 0); }
  ...
  public boolean contains(int id) { return (all != ids.get(id)); }
  ...
  public boolean setAll(boolean all) { return (all ? addAll() : removeAll()); }
