 ...
 * Tints menu icon
 **/
public static void setMenuIconTint(Context context, MenuItem item,
 ...
 **/
public static void setDrawableTint(Context context, Drawable drawable,
                                   @AttrRes int colorAttrRes) {
 ...
 **/
public static void setDrawableColor(Context context, Drawable drawable,
                                    @AttrRes int colorAttrRes) {
	int colorRes = getResourceId(context, colorAttrRes);
	int color = ContextCompat.getColor(context, colorRes);
	if (drawable instanceof ShapeDrawable) {
		...
		setDrawableColor(context, ((RotateDrawable)drawable).getDrawable(),
		                 colorAttrRes);
	}
}
...
public static void showToast(final Context context, final String message,
	...
	handler.post(new Runnable() {
			@Override
			public void run() {
			        Toast.makeText(context.getApplicationContext(), message, duration)
			        .show();
			}
		});
}
 ...
 */
public static void scaleViewOnTablet(Context context, View view,
...
public static DateFormat getYearLessDateFormat(DateFormat dateFormat) {
	if (dateFormat instanceof SimpleDateFormat) {
		...
		String regex = fullPattern.contains("de") ? "[^Mm]*[Yy]+[^Mm]*"
		                                : "[^DdMm]*[Yy]+[^DdMm]*";
