...
public static final String ACTION_JOURNAL =
	"com.kaliturin.blacklist.ACTION_JOURNAL";
public static final String ACTION_SMS_CONVERSATIONS =
	"com.kaliturin.blacklist.ACTION_SMS_CONVERSATIONS";
public static final String ACTION_SETTINGS =
	"com.kaliturin.blacklist.ACTION_SETTINGS";
public static final String ACTION_SMS_SEND_TO =
...
protected void onCreate(Bundle savedInstanceState) {
	...
	ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
		this, drawer, toolbar, R.string.Open_navigation_drawer,
...
protected void onActivityResult(int requestCode, int resultCode,
	...
	// check for result code from the child activity (it could be a
	// dialog-activity)
...
public void onRequestPermissionsResult(int requestCode,
	...
	Permissions.onRequestPermissionsResult(requestCode, permissions,
	                                       grantResults);
...
private SMSConversationsListFragment smsFragment =
	new SMSConversationsListFragment();
...
private void switchFragment(Fragment fragment, Bundle arguments) {
	...
	if (current != fragment) {
		...
		.beginTransaction()
		.replace(R.id.frame_layout, fragment, CURRENT_FRAGMENT)
		.commit();
	}
}
...
private void showSendSMSActivity() {
	...
	if (threadId >= 0) {
		...
		CustomFragmentActivity.show(this, title, SMSConversationFragment.class,
		                            arguments);
	}
