...
public class ContactsCursorAdapter extends CursorAdapter {
  ...
  private RowOnLongClickListener rowOnLongClickListener =
      new RowOnLongClickListener();

  public ContactsCursorAdapter(Context context) { super(context, null, 0); }
  ...
  public boolean hasCheckedItems() { return checkedItems.getSize() > 0; }
  ...
  private class ViewHolder {
    ...
    ViewHolder(Context context, CheckableLinearLayout rowView,
               TextView nameTextView, TextView numbersTextView,
               CheckBox checkBox) {
      this.contact = null;
      this.itemId = 0;
  ...
  private String[] getSortedNumberTitles(Context context,
