...
public class SMSConversationsListCursorAdapter extends CursorAdapter {
  ...
  private LongSparseArray<SMSConversation> smsConversationCache =
      new LongSparseArray<>();
  ...
  public View newView(Context context, Cursor cursor, ViewGroup parent) {
    ...
    View view =
        inflater.inflate(R.layout.row_sms_conversations_list, parent, false);
  ...
  // Clears the cache
  private void invalidateCache() { smsConversationCache.clear(); }
  ...
  private class ViewHolder {
    ...
    ViewHolder(View rowView) {
      this(rowView, (TextView)rowView.findViewById(R.id.address),
    ...
    ViewHolder(View rowView, TextView addressTextView, TextView snippetTextView,
               TextView dateTextView, TextView unreadTextView) {
      this.model = null;
