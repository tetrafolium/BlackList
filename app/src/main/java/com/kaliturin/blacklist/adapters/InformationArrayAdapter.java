...
public class InformationArrayAdapter
    extends ArrayAdapter<InformationArrayAdapter.Model> {
  private SparseArray<ViewHolder> rowsArray = new SparseArray<>();

  public InformationArrayAdapter(Context context) { super(context, 0); }
  ...
  private void addModel(int type, @StringRes int titleId,
                        @StringRes int commentId) {
