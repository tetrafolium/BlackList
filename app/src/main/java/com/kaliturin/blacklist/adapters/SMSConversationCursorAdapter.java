...
public class SMSConversationCursorAdapter extends CursorAdapter {
  ...
  private class ViewHolder {
    ...
    ViewHolder(View rowView) {
      this(rowView, rowView.findViewById(R.id.content_shape),
           (TextView)rowView.findViewById(R.id.body),
           (TextView)rowView.findViewById(R.id.date));
    }

    ViewHolder(View rowView, View contentView, TextView snippetTextView,
    ...
    void setModel(Context context, SMSMessage message) {
      ...
      default:
        ...
        if (calendar.get(Calendar.YEAR) == currentYear) {
          ...
          if (calendar.get(Calendar.DAY_OF_YEAR) == currentDay) {
            ...
            // year-less format
            text = timeFormat.format(date) + ", " +
                   yearLessDateFormat.format(date);
          }
        } else {
          // full format
      ...
      rowView.setPadding(padding.left, padding.top, padding.right,
                         padding.bottom);
