 ...
 **/
public static void sendSMSWasWritten(Context context,
...
/**
 * Sends internal event of deleting the SMS from content provider, which
 * causes onSMSWasDeleted invocation of registered receivers.
 **/
public static void sendSMSWasDeleted(Context context,
                                     @NonNull String phoneNumber) {
	Intent intent = new Intent(TAG);
